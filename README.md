...
```
api/v1/school/:schoolId/group/:groupId/student/:studentId/progress - get - return progress[]
api/v1/school/:schoolId/group/:groupId/student/:studentId/progress/:id - get - param[id] return progress
api/v1/school/:schoolId/group/:groupId/student/:studentId/progress - post - body[rating, lessonTitle] return progress
api/v1/school/:schoolId/group/:groupId/student/:studentId/progress/:id - put - param[id], body[rating, lessonTitle] return progress
api/v1/school/:schoolId/group/:groupId/student/:studentId/progress/:id - delete - param[id] return progress
```

### screen-db

![database-screen](school-api-db-screen.png)
...
```
router необходим для реализации авторизации через jwt.
